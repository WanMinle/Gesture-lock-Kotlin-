...
import com.example.minlewan.testmimasuo.R
import com.example.minlewan.testmimasuo.GestureLockView.Mode
...
class GestureLockViewGroup @JvmOverloads constructor(context: Context, attrs: AttributeSet,
    ...
    private fun checkPositionInChild(child: View, x: Int, y: Int): Boolean {
        ...
        return if (x >= child.left + padding && x <= child.right - padding
                && y >= child.top + padding
